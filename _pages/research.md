...
* [Coca-Based Local Growth and Its Socio-Environmental Impacts in Colombia](/files/Marin-Fernandez-Velez-Martinez-Murillo-coca-based-local-growth-2025.pdf){:style="color:#2E5C8A;text-decoration:underline" target="_blank" rel="noopener"} (with L. Marín-Llanes, M. A. Vélez, E. Martínez-González & P. Murillo-Sandoval) — — *Revise and Resubmit, Journal of Development Economics*.{: style="margin-bottom: 0.2em;"}
  ...
  <details style="display:block;margin-left:1.5rem;margin-top:-1.2em;">
    ...
    <details style="display:block;margin-left:5.5rem;margin-top:-1.6em;">
    <summary style="background-color: #ffffff; padding: 2px 8px; border: 1px solid #b3d9e6; border-radius: 12px; display: inline-block; cursor: pointer; font-size: 0.75em;">Media Coverage</summary>
    <ul>
...
<div style="display:flex; align-items:center; gap:6px; margin-left:3.7rem; margin-top:-1.2em;">
  ...
  <details style="display:inline-block; margin:0;">
    <summary style="background-color:#ffffff; padding:2px 8px; border:1px solid #b3d9e6; 
                    ...
                    font-size:0.75em; list-style:none;">
      Abstract
    </summary>
    <blockquote>
  ...
  <a href="https://www.iza.org/publications/dp/18082/local-public-goods-and-property-tax-compliance-experimental-evidence-from-street-pavement" 
     ...
     style="background-color:#ffffff; padding:2px 8px; border:1px solid #b3d9e6; 
            border-radius:12px; display:inline-block; font-size:0.75em; 
